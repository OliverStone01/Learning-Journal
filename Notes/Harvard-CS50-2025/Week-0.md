...
- How binary bits and bytes are how computers represent numbers, text, images, music, and videos.
- Pseudocode is code writen to be human-readable.
- Basic building blocks including functions, conditionals, loops, and variables.
- Building projects in Scratch
---
...
To represent numbers, we are going to use lightbulbs instead of transisters just for this example.
...
![ASCII map](/Notes/img/ASCII-map.jpeg)
...
Each device manufacturer may display emojis slightly diffrently, even though Unicode ones and zeros are standardised.
...
Video is many images stored together and displayed one after the other in a flipbook style.

Music can also be represented using zeros and ones.

#### Algortithms

Problem solving is the center to computer science and programming. An algorithm is a step-by-step set of instructions to solve a problem.
...
![Algorithm Chart](/Notes/img/algorithm-time.jpeg)
...
This is the process of converting code into code.

Psudocode is a human-readable version of your code. for example, here is the thirst algorithm above written as sudo code:
```
...
13   Quit 
```
Pseudocoding is crucial for at least two reasons. Firstly, it helps you think through the logic of your problem before creating formal code. Secondly, it allows you to explain your coding decisions and how your code works to others.
...
...
```
As you can see, just by programming a hanful of interactions, you are already using 7 lines of code. So how many lines would be required for modern AI...
...
![Scratch IDE](/Notes/img/Scratch-IDE.jpeg)
...
Scratch operates on a cooridinate system:
![Scratch Coordination](/Notes/img/Scratch-coordination.jpeg)
...
![Scratch Hello, world black box](/Notes/img/Scratch-hello-world.jpeg)

#### Hello, You

To make your program more interactive, have the cat greet a specific person. 

![Scratch Hello, you black box](/Notes/img/Scratch-hello-you.jpeg)
...
![Scratch join black box](/Notes/img/Scratch-join.jpeg)
...
In programming and even within Scratch, we can see abstaction in action.

![Scratch meowing once, three times](/Notes/img/Scratch-loop-one.jpeg)

You’re repeating the same thing over and over again. If you see yourself coding the same statements repeatedly, you could program more cleverly by abstracting away this repetitive code.

![Scratch meowing three times, once](/Notes/img/Scratch-loop-two.jpeg)
...
![Scratch define meow](/Notes/img/Scratch-meow-function.jpeg)
...
![Scratch function with n loop](/Notes/img/Scratch-function-n.jpeg)
...
Programming is often a process of trial and error. If you get frustrated, take time to talk yourself though the problem. 
